...
typedef NS_ENUM(AEKeyword, MusicEKnd) {
...
typedef NS_ENUM(AEKeyword, MusicEnum) {
...
typedef NS_ENUM(AEKeyword, MusicEPlS) {
...
typedef NS_ENUM(AEKeyword, MusicERpt) {
	MusicERptOff = 'kRpO',
	MusicERptOne = 'kRp1',
	MusicERptAll = 'kAll'
};

typedef NS_ENUM(AEKeyword, MusicEShM) {
	MusicEShMSongs = 'kShS',
	MusicEShMAlbums = 'kShA',
	MusicEShMGroupings = 'kShG'
};

typedef NS_ENUM(AEKeyword, MusicESrc) {
...
typedef NS_ENUM(AEKeyword, MusicESrA) {
...
typedef NS_ENUM(AEKeyword, MusicESpK) {
	MusicESpKNone = 'kNon',
...
typedef NS_ENUM(AEKeyword, MusicEClS) {
